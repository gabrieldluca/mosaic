...
public class DepthController: UIViewController, LevelDelegate {
    ...
    internal func levelSetup() {
        ...
        let _ = addDescription(toView: self.view, withText: "The quality of being profound or deep.")
        addLevelNumber(toView: self.view, withText: "2")
        
        // MARK: Adding objective shape
        let objective = UIImageView(image: UIImage(named:"Images/Pieces/Depth/objective.png"))
        objective.frame = CGRect(x: 235, y: 225, width: 88.86, height: 100)
